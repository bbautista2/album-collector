...
-- Crea la tabla exchange_notifications, RLS, función find_exchange_partners
-- y habilita Realtime
-- ============================================================================
...
-- 4. Función find_exchange_partners
...
-- 5. Habilitar Realtime (safe: solo si la publicación existe)
DO $$
BEGIN
