...
-- ============================================================================
-- TABLA: exchange_notifications
-- Notificaciones de solicitudes de intercambio entre usuarios
-- ============================================================================
...
-- ============================================================================
-- FUNCIÓN: find_exchange_partners
-- Busca usuarios en la misma ciudad que tengan una figurita como repetida
-- ============================================================================
...
COMMENT ON TABLE public.exchange_notifications IS 'Solicitudes de intercambio entre usuarios';
...
-- Habilitar Realtime para notificaciones de intercambio
ALTER PUBLICATION supabase_realtime ADD TABLE IF NOT EXISTS public.exchange_notifications;
